...
class PearsonCorrcoef(MetricWrapper):
    def __init__(self, ignore_null: bool = False):
        super().__init__(torchmetrics.PearsonCorrcoef(), dtype=torch.float)
...
class SpearmanCorrcoef(MetricWrapper):
    def __init__(self, ignore_null: bool = False):
        super().__init__(torchmetrics.SpearmanCorrcoef(), dtype=torch.float)
        self.ignore_null = ignore_null
